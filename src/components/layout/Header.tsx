      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex items-center justify-between h-16">
          ...
          <Link href="/" className="flex items-center gap-2.5 group">
            <div className="w-9 h-9 bg-gradient-to-br from-indigo-500 to-violet-600 rounded-xl flex items-center justify-center text-white font-bold text-base shadow-sm shadow-indigo-200 transition-transform group-hover:scale-105">
              A
            </div>
            <div className="hidden sm:block">
              <span className="text-[15px] font-semibold text-gray-900 leading-none block">
                API Showcase
              </span>
